...
/**
 * Stream is one of the essential classes used in privacystreamsevents.
 * Most personal data access/process operation in privacystreamsevents use Stream as the intermediate.
 *
